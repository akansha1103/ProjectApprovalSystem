...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <meta name="viewport" content="width=devidth, initial-scale=1">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                            ...
                                            <ul class="nav navbar-nav navbar-right">
                                                ...
                                                <li><a href="incharge.jsp">IN-CHARGE</a></li>
                                    ...
                                    <div class="main_home_slider text-center">
                                        <div class="single_home_slider">
                                            <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                                ...
                                                <p> we are here to help you convert your ideas into product
                                    </p>
                                                <div class="home_btn">
                                                   <a href="reg.jsp" class="btn btn-lg m_t_10">SIGN UP</a>
                                                    <a href="index1.jsp" class="btn btn-default">SIGN IN</a>
                                                </div>
                                        ...
                                        <div class="single_home_slider">
                                            <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                                ...
                                                <h1>SHARE YOUR IDEAS WITH US</h1>
                                                <div class="separator"></div>
                                                <p>we are here to help you convert your ideas into product</p>
                                                <div class="home_btn">
                                                    <a href="" class="btn btn-lg m_t_10">SIGN UP</a>
                        ...
                        <div class="main_feature text-center">
                            ...
                            <div class="col-sm-3">
                                <div class="single_feature">
                                    ...
                                    <p>Innovate your work with a new experience.
                            ...
                            <div class="col-sm-3">
                                <div class="single_feature">
                                    ...
                                    <h4>DISCUSSION</h4>
                                    <div class="separator3"></div>
                                    <p>Discussion leads to explore new areas and it always helps to come up with better solution to any problem.
                            ...
                            <div class="col-sm-3">
                                <div class="single_feature">
                                    ...
                                    <h4>CREATIVITY</h4>
                                    <div class="separator3"></div>
                                    <p> Give a better look and feel to your work with the help of designing.
                                        </p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="single_feature">
                                    ...
                                    <h4>GUIDANCE</h4>
                                    <div class="separator3"></div>
                                    <p> True guidance is like a small torch in a dark forest .it doesn't show everything at once but gives enough light for the next step to be safe.
                                        </p>
                                </div>
                            </div>
                        ...
                        <div class="main_history">
                            ...
                            <div class="col-sm-6">
                                <div class="single_history_content">
                                    ...
                                    <p>It's often believed that sharing leads to inventing and discovering new things.The same concept is being
                                    adapted here where students are give "an open mic" to discuss their innovative ideas and guided by their 
                                     mentors via online process. This assistance via online platform gives ease to the users to avail it anywhere 
                                    at anytime. Thus,helping Student community to explore at an another level!</p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10 col-sm-offset-1 col-xs-9 col-xs-offset-1">
                                                    <article class="single_service_right_text">
                                                        <h4>SHARE IDEAS</h4>
                                                        <p> This is a platform to share and discuss the project ideas with the respective mentors of the students.
                                                            </p>
                                                    </article>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10 col-sm-offset-1 col-xs-9 col-xs-offset-1">
                                                    <article class="single_service_right_text">
                                                        ...
                                                        <p>After approval of the ideas projects can be uploaded for the evaluation purpose.
                                        ...
                                        <div class="col-md-12 col-sm-10 col-xs-10 margin-bottom-60">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10 col-sm-offset-1 col-xs-9 col-xs-offset-1 margin-bottom-20">
                                                    <article class="single_service_right_text">
                                                        <h4>FEEDBACK</h4>
                                                        <p>Feedback always helps to improve.Here incharge and Mentors can give feedback to the students about their projects.
                                                            </p>
                                                    </article>
                                                </div>
                                                <div class="col-sm-1 col-xs-1">
                        ...
                        <div class="main_portfolio">
                            <div class="col-sm-12">
                                <div class="head_title text-center">
                                    ...
                                    <div class="subtitle">
                                   Here are some references which you can use to get some good project 
                                    </div>
                                    <div class="separator"></div>
                                </div>
                            </div>
                            <div class="work_menu text-center">
                                <div id="filters" class="toolbar mb2 mt2">
                                    <a href="https://www.geeksforgeeks.org/computer-science-projects/#ProjectIdea" target="_blank">Geeks</a>/
                                    <a href="https://www.elprocus.com/category/project-ideas/" target="_blank">EL-PRO-CUS</a>/
                                    <a href="https://www.guvy.in" target="_blank">GUVY</a>/
                            ...
                            <div id="portfoliowork"> 
                                <div class="single_portfolio tile scale-anm web grid-item-width2 video" >
                                    ...
                                    <a href="myimg1." class="portfolio-img">
                                       
                                    </a>
                                </div>
                                <div class="single_portfolio tile scale-anm bcards photo" >
                                    <img src="myimg4.jpg" alt="" />
                                    <a href="myimg4.jpg" class="portfolio-img">
                                        
                                    </a>
                                </div>
                                <div class="single_portfolio tile scale-anm web video">
                                    <img src="myimg5.jpg" alt="" />
                                    <a href="myimg5.jpg" class="portfolio-img">
                                ...
                                <div class="single_portfolio tile scale-anm web photo" >
                                 ...
                                 <div class="single_portfolio tile scale-anm web video">
                                    ...
                                    <a href="myimg2.jpg" class="portfolio-img">
                                ...
                                <div class="single_portfolio tile scale-anm photo flyers">
                                    <img src="myimg6.jpg" alt="" />
                                    <a href="myimg6.jpg" class="portfolio-img">
                                       
                                    </a>
                                </div>

                                <div class="single_portfolio tile scale-anm bcards video" >
                                    <img src="myimg3.jpg" alt="" />
                                    <a href="myimg3.jpg" class="portfolio-img">
                ...
                <div class="main_team_area">
                    <div class="container">
                        <div class="row">
                            ...
                            </div><!-- End of main team contant --> <!-- End of main team contant --> 
                        </div>
                    </div><!-- End of container -->
                </div>
