    <%-- 
    Document   : stud_main
    Created on : Mar 4, 2019, 9:09:14 AM
    Author     : Dell
--%>
...
.w3-half img:hover{opacity:1}
  ...
  <div class="w3-bar-block">
    ...
    <a href="project_idea.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Project Ideas</a> 
    <a href="documents.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Upload Documents</a> 
    <a href="query.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Query</a> 
     <a href="queryresponse.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Query Responses</a> 
    <a href="display.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Mentor</a> 
    <a href="project_status.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Project Status</a>
  </div>
</nav>
...
String sql ="select * from stu_signup where userid="+mid;
