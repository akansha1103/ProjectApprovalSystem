...
.w3-half img:hover{opacity:1}
  ...
  <div class="w3-bar-block">
    ...
    <a href="project_details.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Project Details</a> 
    <a href="mentor_details.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Mentor Details</a>
     <a href="test5.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Assign Mentors</a>
    <a href="test4.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Update Allotments</a>
    <a href="incharge_query.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Query</a> 
    <a href="download.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Project Documents</a> 
...
String sql ="select * from incharge_signup where userid="+mid;
ResultSet resultSet = statement.executeQuery(sql);
int i=0;
if(resultSet.next()){
    String inc=resultSet.getString("name");
    out.println(inc);
